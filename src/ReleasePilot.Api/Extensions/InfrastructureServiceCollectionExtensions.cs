...
public static class InfrastructureServiceCollectionExtensions
{
    public static IServiceCollection AddInfrastructureLayer(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<PromotionRabbitMqPublisherEventHandler>();
        ...
        services.AddScoped<IDomainEventHandler<PromotionRequestedDomainEvent>>(sp => sp.GetRequiredService<PromotionRabbitMqPublisherEventHandler>());
        ...
        services.AddScoped<IDomainEventHandler<PromotionApprovedDomainEvent>>(sp => sp.GetRequiredService<PromotionRabbitMqPublisherEventHandler>());
        ...
        services.AddScoped<IDomainEventHandler<DeploymentStartedDomainEvent>>(sp => sp.GetRequiredService<PromotionRabbitMqPublisherEventHandler>());
        ...
        services.AddScoped<IDomainEventHandler<PromotionCompletedDomainEvent>>(sp => sp.GetRequiredService<PromotionRabbitMqPublisherEventHandler>());
        ...
        services.AddScoped<IDomainEventHandler<PromotionRolledBackDomainEvent>>(sp => sp.GetRequiredService<PromotionRabbitMqPublisherEventHandler>());
        ...
        services.AddScoped<IDomainEventHandler<PromotionCancelledDomainEvent>>(sp => sp.GetRequiredService<PromotionRabbitMqPublisherEventHandler>());
